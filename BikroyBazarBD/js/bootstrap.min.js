...
!(function (t, e) {
        ...
        off(t, e, s, i) {
            ...
            if (void 0 === o) {
                ...
                for (const [s, i] of Object.entries(c)) {
                    const n = s.replace(A, "");
                    (a && !e.includes(n)) ||
                        N(t, l, r, i.callable, i.delegationSelector);
                }
            } else {
        ...
        K = (t, e = "hide") => {
            ...
            M.on(document, s, `[data-bs-dismiss="${i}"]`, function (s) {
                if (
                    ...
                    return;
                const n =
                    V.getElementFromSelector(this) || this.closest(`.${i}`);
    ...
    class J extends q {
        ...
        _initEvents() {
            this._supportPointerEvents
                ? (M.on(this._element, "pointerdown.bs.swipe", (t) =>
                      this._start(t)
                  ),
                  M.on(this._element, "pointerup.bs.swipe", (t) =>
                      this._end(t)
                  ),
                  this._element.classList.add("pointer-event"))
                : (M.on(this._element, "touchstart.bs.swipe", (t) =>
                      this._start(t)
                  ),
                  M.on(this._element, "touchmove.bs.swipe", (t) =>
                      this._move(t)
                  ),
                  M.on(this._element, "touchend.bs.swipe", (t) =>
                      this._end(t)
                  ));
        }
    ...
    class ct extends W {
        ...
        _addEventListeners() {
            this._config.keyboard &&
                M.on(this._element, "keydown.bs.carousel", (t) =>
                    this._keydown(t)
                ),
    ...
    class xt extends W {
        ...
        _completeHide(t) {
            if (
                !M.trigger(this._element, "hide.bs.dropdown", t)
                    .defaultPrevented
            ) {
    ...
    class Yt extends q {
        ...
        activate() {
            this._isActive ||
                ...
                M.off(document, Vt),
                M.on(document, "focusin.bs.focustrap", (t) =>
    ...
    class ie extends W {
        ...
        show(t) {
            this._isShown ||
                ...
                M.trigger(this._element, Gt, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
    ...
    const _e = new Set([
        ...
        me = (t, e) => {
            ...
            return e.includes(s)
                ? !_e.has(s) ||
                      Boolean(ge.test(t.nodeValue) || fe.test(t.nodeValue))
    ...
    class Ge extends W {
        constructor(t) {
            super(t),
                ...
                this._parent &&
                    ...
                    M.on(this._element, "keydown.bs.tab", (t) =>
                        this._keydown(t)
                    ));
        }
        static get NAME() {
        ...
        show() {
            ...
            const e = this._getActiveElem(),
                s = e
                    ? M.trigger(e, "hide.bs.tab", { relatedTarget: t })
                    : null;
            M.trigger(t, "show.bs.tab", { relatedTarget: e })
                .defaultPrevented ||
