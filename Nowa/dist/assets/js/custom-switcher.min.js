...
function switcherClick() {
  ...
  let shadowVar = regular.addEventListener("click", () => {
    ...
    localStorage.setItem("nowaregular", true);
  ...
  let noShadowVar = classic.addEventListener("click", () => {
    ...
    localStorage.setItem("nowaclassic", true);
  ...
  let modernVar = modern.addEventListener("click", () => {
    ...
    localStorage.setItem("nowamodern", true);
    localStorage.removeItem("nowaregular");
    localStorage.removeItem("nowaclassic");
  });
  ...
  let verticalVar = verticalBtn.addEventListener("click", () => {
    ...
    // local storage
    localStorage.removeItem("nowalayout");
...
function lightFn() {
  ...
  localStorage.removeItem("nowabgColor");
  localStorage.removeItem("nowaheaderbg");
  localStorage.removeItem("nowabgwhite");
  localStorage.removeItem("nowamenubg");
  localStorage.removeItem("nowamenubg");
  checkOptions();
...
function checkOptions() {
  ...
  // light header
  if (localStorage.getItem("nowaHeader") === "light") {
    document.querySelector("#switcher-header-light").checked = true;
  }

  // color header
  if (localStorage.getItem("nowaHeader") === "color") {
    document.querySelector("#switcher-header-primary").checked = true;
  }

  // gradient header
  if (localStorage.getItem("nowaHeader") === "gradient") {
    document.querySelector("#switcher-header-gradient").checked = true;
  }

  // dark header
  if (localStorage.getItem("nowaHeader") === "dark") {
    document.querySelector("#switcher-header-dark").checked = true;
  }
  // transparent header
  if (localStorage.getItem("nowaHeader") === "transparent") {
    document.querySelector("#switcher-header-transparent").checked = true;
  }

  // light menu
  if (localStorage.getItem("nowaMenu") === "light") {
    document.querySelector("#switcher-menu-light").checked = true;
  }

  // color menu
  if (localStorage.getItem("nowaMenu") === "color") {
    document.querySelector("#switcher-menu-primary").checked = true;
  }

  // gradient menu
  if (localStorage.getItem("nowaMenu") === "gradient") {
    document.querySelector("#switcher-menu-gradient").checked = true;
  }

  // dark menu
  if (localStorage.getItem("nowaMenu") === "dark") {
    document.querySelector("#switcher-menu-dark").checked = true;
  }
  // transparent menu
  if (localStorage.getItem("nowaMenu") === "transparent") {
    document.querySelector("#switcher-menu-transparent").checked = true;
  }

  //boxed
  if (localStorage.getItem("nowaboxed")) {
    document.querySelector("#switcher-boxed").checked = true;
  }

  //scrollable
  if (localStorage.getItem("nowaheaderscrollable")) {
    document.querySelector("#switcher-header-scroll").checked = true;
  }
  if (localStorage.getItem("nowamenuscrollable")) {
    document.querySelector("#switcher-menu-scroll").checked = true;
  }

  //fixed
  if (localStorage.getItem("nowaheaderfixed")) {
    document.querySelector("#switcher-header-fixed").checked = true;
  }
  if (localStorage.getItem("nowamenufixed")) {
    document.querySelector("#switcher-menu-fixed").checked = true;
  }

  //classic
  if (localStorage.getItem("nowaclassic")) {
    document.querySelector("#switcher-classic").checked = true;
  }

  //modern
  if (localStorage.getItem("nowamodern")) {
...
function updateColors() {
  ...
  if (document.querySelector("#radialbar-basic1") !== null) {
    radialbarBasic();
  }
