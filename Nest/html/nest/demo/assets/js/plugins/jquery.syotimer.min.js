...
!(function (i, e) {
  ...
  var m = "day",
    ...
    r = { second: !1, minute: !1, hour: !1, day: !1 },
    c = {
      init: function (e) {
        var t = l.extend({}, o, e || {});
        (t.itemTypes = y.getItemTypesByLayout(t.layout)),
          (t._itemsHas = l.extend({}, r));
        for (var i = 0; i < t.itemTypes.length; i++)
          t._itemsHas[t.itemTypes[i]] = !0;
        return this.each(function () {
          l(this).data("syotimer-options", t),
      ...
      _render: function () {
        for (
          var e = l(this),
            ...
            i = y.getTimerItem(),
            n = l("<div/>", { class: "syotimer__head" }).html(t.headTitle),
            o = l("<div/>", { class: "syotimer__body" }),
            r = l("<div/>", { class: "syotimer__footer" }).html(t.footTitle),
            a = {},
            s = 0;
          s < t.itemTypes.length;
          s++
        ) {
          var d = i.clone();
          d.addClass("syotimer-cell_type_" + t.itemTypes[s]),
            o.append(d),
            (a[t.itemTypes[s]] = d);
        }
        var u = { headBlock: n, bodyBlock: o, footBlock: r };
        e.data("syotimer-blocks", u)
          .data("syotimer-items", a)
          .addClass("syotimer")
          .append(n)
          .append(o)
          .append(r);
      ...
      _perSecondHandler: function () {
        ...
        0 <= r
          ? (c._refreshUnitsDom.apply(this, [r]),
            c._applyEffectSwitch.apply(this, [t.effectType]))
          : ((e = l.extend(e, e.data("syotimer-blocks"))), t.afterDeadline(e));
      },
      _refreshUnitsDom: function (e) {
        ...
        i._itemsHas.day || (r.hour += 24 * r.day),
          i._itemsHas.hour || (r.minute += 60 * r.hour),
          i._itemsHas.minute || (r.second += 60 * r.minute);
        for (var a = 0; a < o.length; a++) {
          var s = o[a],
            d = r[s],
            u = n[s];
          u.data("syotimer-unit-value", d),
            l(".syotimer-cell__value", u).html(
              y.format2(d, s !== m && i.doubleNumbers)
            ),
            l(".syotimer-cell__unit", u).html(
      ...
      _applyEffectSwitch: function (e, t) {
        ...
        "none" === e
          ...
          : "opacity" !== e ||
            ((i = a.data("syotimer-items")[t]) &&
              ((n = u.next(t)),
              (o = i.data("syotimer-unit-value")),
    ...
    y = {
      ...
      getSecondsToDeadLine: function (e, t) {
        var i,
          ...
          a = Math.floor(a),
          s = t.periodic
            ? ((r = e / (1e3 * (o = y.getPeriodUnit(t.periodUnit)))),
              (r = Math.ceil(r)),
              (r = Math.abs(r)),
              0 <= a
                ? ((n =
                    0 === (n = r % t.periodInterval) ? t.periodInterval : n),
                  --n)
                : (n = t.periodInterval - (r % t.periodInterval)),
              0 == (i = a % o) && a < 0 && n--,
              Math.abs(n * o + i))
            : a;
        return s;
      ...
      getDifferenceWithTimezone: function (e, t, i) {
        ...
        return (
          "local" !== i.timeZone &&
            (o =
              1e3 *
              (parseFloat(i.timeZone) * y.getPeriodUnit(a) -
                -e.getTimezoneOffset() * y.getPeriodUnit(s))),
          i.ignoreTransferTime &&
            (r =
              1e3 *
              (-e.getTimezoneOffset() * y.getPeriodUnit(s) -
                -t.getTimezoneOffset() * y.getPeriodUnit(s))),
          n - (o + r)
        );
      },
