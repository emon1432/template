              ...
              this.data.current(function (e) {
                ...
                t.$results
                  ...
                  .each(function () {
                    ...
                    (null == t.element && -1 < p.inArray(n, r))
              ...
              (n.prototype.apply = function (t) {
                if (
                  ...
                  if (
                    ...
                    0 < t.maximumSelectionLength &&
                      (t.dataAdapter = A.Decorate(t.dataAdapter, L)),
                ...
                if (
                  (null == t.resultsAdapter &&
                    ((t.resultsAdapter = m),
                    null != t.ajax &&
                      (t.resultsAdapter = A.Decorate(t.resultsAdapter, k)),
                    null != t.placeholder &&
                      (t.resultsAdapter = A.Decorate(t.resultsAdapter, P)),
                    t.selectOnClose &&
                      (t.resultsAdapter = A.Decorate(t.resultsAdapter, M))),
                  ...
                  if (
                    (0 !== t.minimumResultsForSearch &&
                      (t.dropdownAdapter = A.Decorate(t.dropdownAdapter, U)),
                    t.closeOnSelect &&
                ...
                this.defaults = {
                  ...
                  matcher: function e(t, n) {
                    ...
                    if (n.children && 0 < n.children.length) {
                      for (
                        var r = f.extend(!0, {}, n), i = n.children.length - 1;
                        0 <= i;
                        i--
                      )
