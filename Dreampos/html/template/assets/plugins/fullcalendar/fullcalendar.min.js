...
!(function (t) {
  ...
  function z(t, e) {
    ...
    if (a > l && o < u)
      return (
        ...
        a <= u ? ((i = a.clone()), (s = !0)) : ((i = u.clone()), (s = !1)),
      ...
      (p = e.opt("theme") ? "ui" : "fc"),
        i
          ? (g
              ? g.empty()
              : (g = this.el =
                  t("<div class='fc-toolbar " + n.extraClasses + "'/>")),
            g
              .append(o("left"))
              .append(o("right"))
              .append(o("center"))
              ...
              "title" == i
                ...
                : ((r = o[i])
                    ...
                    : e[i] &&
                      ...
                      (d = a[i])),
                  h &&
                    ((f = r ? r.themeIcon : e.opt("themeButtonIcons")[i]),
                    (g = r ? r.icon : e.opt("buttonIcons")[i]),
                    (m = c
                      ? ht(c)
                      : f && e.opt("theme")
                      ? "<span class='ui-icon ui-icon-" + f + "'></span>"
                      : g && !e.opt("theme")
                      ? "<span class='fc-icon fc-icon-" + g + "'></span>"
                      : ht(d)),
                    (y = [
                      "fc-" + i + "-button",
                      p + "-button",
                    ...
                    (w = t(
                      ...
                      .click(function (t) {
                        w.hasClass(p + "-state-disabled") ||
                          (h(t),
                          (w.hasClass(p + "-state-active") ||
                            w.hasClass(p + "-state-disabled")) &&
                            w.removeClass(p + "-state-hover"));
                      })
                      .mousedown(function () {
                      ...
                      .hover(
                        ...
                        function () {
                          w.removeClass(p + "-state-hover").removeClass(
                            p + "-state-down"
                          );
                        }
                      )),
  ...
  function Ut() {
    ...
    function f(e, n) {
      ...
      for (i = 0; i < s.length; i++) {
        if (
          !0 ===
          (r = s[i].call(q, e, U.clone(), j.clone(), q.opt("timezone"), n))
        )
          return;
      ...
      if (o)
        t.isFunction(o)
          ? (q.pushLoading(),
            o.call(q, U.clone(), j.clone(), q.opt("timezone"), function (t) {
              n(t), q.popLoading();
            }))
          : t.isArray(o)
          ? n(o)
      ...
      for (s = 0; s < t.length; s++)
        if ((r = z(t[s]))) {
          for (n = _(r), o = 0; o < n.length; o++)
            (a = n[o]),
              a.source || (e && ($.events.push(a), (a.source = $)), K.push(a));
          l = l.concat(n);
        }
      return l.length && i(), l;
    }
    ...
    function z(n, i) {
      ...
      if (
        ...
        s && ((s = q.moment(s)), s.isValid() || (s = null)),
          (o = n.allDay),
          void 0 === o &&
            (o = ut(i ? i.allDayDefault : void 0, q.opt("allDayDefault"))),
          V(r, s, o, l);
      }
    ...
    function P(t) {
      null == t.allDay &&
        ...
        t.allDay
          ...
          : (t.start.hasTime() || (t.start = q.applyTimezone(t.start.time(0))),
            t.end &&
              !t.end.hasTime() &&
    ...
    function W(e, n, i) {
      ...
      return (
        ...
        (a = r(n.start, s.start)),
        n.end ? ((l = r(n.end, s.end)), (u = l.subtract(a))) : (u = null),
    ...
    return (
      this.each(function (r, s) {
        ...
        "string" == typeof e
          ...
          : l || ((l = new Re(a, e)), a.data("fullCalendar", l), l.render());
      }),
      i
    );
  };
  ...
  var fe = (Zt.EmitterMixin = {
    ...
    ve = (Zt.CoordCache = bt.extend({
      ...
      queryBoundingRect: function () {
        var t;
        return this.els.length > 0 && ((t = c(this.els.eq(0))), !t.is(document))
          ? f(t)
          : null;
      },
    ...
    me = (Zt.DragListener = bt.extend(ge, {
      ...
      startInteraction: function (e, n) {
        ...
        this.isInteracting ||
          ...
          (this.minDistance = ut(n.distance, this.options.distance, 0)),
  ...
  me.mixin({
    ...
    initAutoScroll: function () {
      ...
      (this.isAutoScroll =
        ...
        this.isAutoScroll &&
          this.listenTo(t, "scroll", yt(this.handleDebouncedScroll, 100));
    },
        ...
        t
          ? ((n = { left: b(t), top: E(t) }),
            ...
            r &&
              ...
              (this.origHit && (e = R(this.origHit, e) || e), (i = I(e))),
        ...
        if (n.length) {
          ...
          t(o).each(function (e, i) {
            var o = n[e],
              l = t(i);
            s && (l = s.call(r, o, l)),
              l && ((l = t(l)), l.is(r.fillSegTag) && ((o.el = l), a.push(o)));
          });
        }
        return a;
      },
  ...
  be.mixin({
    ...
    handleSegClick: function (t, e) {
      !1 === this.view.publiclyTrigger("eventClick", t.el[0], t.event, e) &&
        e.preventDefault();
    },
          ...
          delete t.component,
            n.stop(!i, function () {
              e && (a.unrenderDrag(), r.segDragStop(t, s)),
                i ? a.reportSegDrop(t, i, r.largeUnit, l, s) : a.showEvent(u);
            }),
    ...
    segDragStart: function (t, e) {
      (this.isDraggingSeg = !0),
        this.view.publiclyTrigger("eventDragStart", t.el[0], t.event, e, {});
    },
    segDragStop: function (t, e) {
      (this.isDraggingSeg = !1),
        this.view.publiclyTrigger("eventDragStop", t.el[0], t.event, e, {});
    },
      ...
      return (
        o.hasTime() === a.hasTime()
          ? ((i = this.diffDates(a, o)),
            ...
            r.start.add(i),
            r.end && r.end.add(i))
          : (r = { start: a.clone(), end: null, allDay: !a.hasTime() }),
        r
      );
    },
        ...
        hitOver: function (t) {
          ...
          n
            ? ((i = r.computeExternalDrop(n, l)),
              (e = i && r.isExternalLocationAllowed(i, l.eventProps)))
            : (e = !1),
            e || ((i = null), s()),
            i && r.renderDrag(i);
        },
      ...
      return (this.segResizeListener = new ye(this, {
        ...
        interactionEnd: function (e) {
          n && r.segResizeStop(t, e),
            i ? a.reportSegResize(t, i, r.largeUnit, u, e) : a.showEvent(h),
    ...
    segResizeStart: function (t, e) {
      (this.isResizingSeg = !0),
        this.view.publiclyTrigger("eventResizeStart", t.el[0], t.event, e, {});
    },
    segResizeStop: function (t, e) {
      (this.isResizingSeg = !1),
        this.view.publiclyTrigger("eventResizeStop", t.el[0], t.event, e, {});
    },
    ...
    computeEventResize: function (t, e, n, i) {
      ...
      return (
        ...
        r.allDay && tt(a) && ((r.allDay = !1), o.normalizeEventTimes(r)),
        r[t].add(a),
    ...
    getSegBorderColor: function (t) {
      return (
        t.event.borderColor || t.event.color || this.getSegDefaultBorderColor(t)
      );
    },
    ...
    getSegDefaultTextColor: function (t) {
      return (
        (t.event.source || {}).textColor || this.view.opt("eventTextColor")
      );
    },
      ...
      renderDates: function (t) {
        ...
        for (
          this.el.html(o),
            ...
            this.rowCoordCache = new ve({ els: this.rowEls, isVertical: !0 }),
    ...
    renderSegRow: function (e, n) {
      function i(e) {
        for (; o < e; )
          (h = (m[r - 1] || [])[o]),
            h
              ? h.attr("rowspan", parseInt(h.attr("rowspan") || 1, 10) + 1)
              : ((h = t("<td/>")), a.append(h)),
            (v[r][o] = h),
            (m[r][o] = h),
            o++;
        ...
        if (
          ...
          for (l = 0; l < s.length; l++) {
            for (
              u = s[l],
                i(u.leftCol),
                h = t('<td class="fc-event-container"/>').append(u.el),
                u.leftCol != u.rightCol
                  ? h.attr("colspan", u.rightCol - u.leftCol + 1)
                  : (m[r][o] = h);
              o <= u.rightCol;
      ...
      limitRow: function (e, n) {
        ...
        if (n && n < S.segLevels.length) {
          for (
            r = S.segLevels[n - 1],
              s = S.cellMatrix,
              o = S.tbodyEl.children().slice(n).addClass("fc-limited").get(),
              a = 0;
            a < r.length;
            a++
          ) {
          ...
          .on("click", function (o) {
            ...
            "function" == typeof a &&
              (a = s.publiclyTrigger(
                "eventLimitClick",
                null,
                { date: l, dayEl: h, moreEl: u, segs: d, hiddenSegs: f },
                o
              )),
              "popover" === a
            ...
            hide: function () {
              if (o.popoverSegs)
                for (var t, e = 0; e < o.popoverSegs.length; ++e)
                  (t = o.popoverSegs[e]),
                    a.publiclyTrigger("eventDestroy", t.event, t.event, t.el);
  ...
  var Te = (Zt.TimeGrid = be.extend(Ee, {
    ...
    renderDates: function () {
      this.el.html(this.renderHtml()),
        ...
        (this.colCoordCache = new ve({ els: this.colEls, isHorizontal: !0 })),
        (this.slatCoordCache = new ve({ els: this.slatEls, isVertical: !0 })),
      ...
      for (
        ...
        (t = this.start.clone().time(a)),
          ...
          (i =
            ...
            r.axisStyleAttr() +
            ">" +
            (n ? "<span>" + ht(t.format(this.labelFormat)) + "</span>" : "") +
            "</td>"),
          (o +=
            '<tr data-time="' +
            t.format("HH:mm:ss") +
    ...
    getHitSpan: function (t) {
      ...
      return (
        n.time(i), (e = n.clone().add(this.snapDuration)), { start: n, end: e }
      );
    },
    getHitEl: function (t) {
        ...
        '<a class="' +
          ...
          (n
            ? '<div class="fc-time" data-start="' +
              ...
              "</span></div>"
            : "") +
          (o.title ? '<div class="fc-title">' + ht(o.title) + "</div>" : "") +
          '</div><div class="fc-bg"/>' +
  ...
  var Ce = (Zt.View = ue.extend({
    ...
    setDate: function (t) {
      ...
      return (
        (e && X(e.activeRange, n.activeRange)) || this.set("dateProfile", n),
        n.date
      );
    },
    unsetDate: function () {
    ...
    processEventUnselect: function (e) {
      this.selectedEvent &&
        (t(e.target).closest(".fc-selected").length || this.unselectEvent());
    },
      ...
      buildRangeFromDuration: function (t, n, i, r) {
        ...
        return (
          ...
          l ||
            ...
            o ? ((a = e.duration(o)), (l = a < i ? O(a, o) : r)) : (l = r)),
          u.startOf(l),
          (s = u.clone().add(i)),
          { start: u, end: s }
        );
  ...
  var Re = (Zt.Calendar = bt.extend(fe, {
    ...
    parseRange: function (t) {
      ...
      return (
        ...
        e || n ? (e && n && n.isBefore(e) ? null : { start: e, end: n }) : null
      );
    },
  ...
  Re.mixin({
    ...
    populateOptionsHash: function () {
      ...
      (t = ut(this.dynamicOverrides.locale, this.overrides.locale)),
        ...
        (s = n([Re.defaults, r, e, this.overrides, this.dynamicOverrides])),
        Yt(s),
          ...
          this.optionsModel.watch(
            ...
            function (e) {
              ...
              e.monthNames && (s._months = e.monthNames),
                ...
                null == r && "ISO" === i && (r = 1),
                null != r && ((n = rt(s._week)), (n.dow = r), (s._week = n)),
      ...
      moment: function () {
        ...
        return (
          "local" === this.opt("timezone")
            ? ((t = Zt.moment.apply(null, arguments)), t.hasTime() && t.local())
            : (t =
          ...
          !!i.class &&
            ...
            s &&
              ...
              o.valueOf() &&
                ...
                (i.duration = o),
                (i.durationUnit = a),
                1 === o.as(a) && ((i.singleUnit = a), c.unshift(l[a] || {})))),
            (i.defaults = n(h)),
            (i.overrides = n(c)),
    ...
    Re.mixin({
      ...
      updateToolbarButtons: function () {
        ...
        this.toolbarsManager.proxyCall(
          n.isValid && !Z(t, e.currentRange) ? "enableButton" : "disableButton",
          "today"
        ),
          this.toolbarsManager.proxyCall(
  ...
  var ze = (Zt.BasicView = Ce.extend({
      ...
      initialize: function () {
        (this.dayGrid = this.instantiateDayGrid()),
          (this.scroller = new He({ overflowX: "hidden", overflowY: "auto" }));
      },
        ...
        for (n = 0; n < s.length; n++)
          if ((i = s[n]))
            for (
              a.append(
                this.dayHeaderHtml(
                  this.view.renderRange.start.clone().add(n, "days")
                )
              ),
